...
{
	/// <summary>An equality comparer for <see cref="SerializableIdentityResource"/> objects.</summary>
	class SerializableIdentityResourceEqualityComparer : SerializableResourceEqualityComparer, IEqualityComparer<SerializableIdentityResource>
	{
		// INTERFACE IMPLEMENTATION: IEqualityComparer<SerializableIdentityResource>
		public bool Equals(SerializableIdentityResource x, SerializableIdentityResource y)
		{
		...
		public int GetHashCode([DisallowNull] SerializableIdentityResource obj)
		{
